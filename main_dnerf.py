...
if __name__ == '__main__':
    ...
    # =================================================================================
    # training options
    parser.add_argument('--iters', type=int, default=7200,
                        help="training iters")
    ...
    parser.add_argument('--dynamic_iters', type=str, default="{'d1': (0, 10800)}",  # 2400 iters
    ...
    if opt.test:
        ...
        trainer = Trainer('ngp', opt, model, device=device, workspace=opt.workspace, optimizer=optimizer, criterion=criterion, ema_decay=None,
                          fp16=opt.fp16, lr_scheduler=scheduler, scheduler_update_every_step=True, metrics=[PSNRMeter()], use_checkpoint=opt.ckpt, eval_interval=5)
